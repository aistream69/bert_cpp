...
enc = BertTokenizer(
    "/home/ubuntu/project/data/bert-base-chinese/vocab.txt",
    do_lower_case=False,
    do_basic_tokenize=False
)

# Tokenizing input text
#text = "[CLS]巴黎是法国的首都[SEP]"
...
config = BertConfig.from_json_file(
    "/home/ubuntu/project/data/bert-base-chinese/config.json"
)
...
model = BertForMaskedLM.from_pretrained(
    "/home/ubuntu/project/data/bert-base-chinese/pytorch_model.bin",
    config=config
)
